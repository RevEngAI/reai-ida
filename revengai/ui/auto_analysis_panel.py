...
class Ui_AutoAnalysisPanel(object):
    ...
    def retranslateUi(self, AutoAnalysisPanel):
        ...
        AutoAnalysisPanel.setWindowTitle(
            _translate("AutoAnalysisPanel", "RevEng.AI Toolkit: Auto Analysis")
        )
        self.collectionsFilter.setPlaceholderText(
            _translate("AutoAnalysisPanel", "Search Collections…")
        )
        self.checkBox.setText(_translate(
            "AutoAnalysisPanel", "Use Debug Symbols"))
        self.tabWidget.setTabText(
            self.tabWidget.indexOf(self.tab),
            _translate("AutoAnalysisPanel", "Collections"),
        )
        ...
        self.tabWidget.setTabText(
            ...
            _translate("AutoAnalysisPanel", "Results"),
        )
